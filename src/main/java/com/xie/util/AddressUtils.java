...
public class AddressUtils {
    ...
    public static String getAddressCity(String content, String encodingString)
            throws UnsupportedEncodingException {
        // 这里调用淘宝API
        String urlStr = "http://ip.taobao.com/service/getIpInfo.php";
        // 从http://whois.pconline.com.cn取得IP所在的省市区信息
        ...
        if (returnStr != null) {
            ...
            return JsonUtil.getValueByKey(returnStr,"city");
        }
        return null;
    }
    /**
    ...
    public static void main(String[] args) {
        ...
        String address = "";
        try {
            address = addressUtils.getAddressCity("ip="+ip, "utf-8");
